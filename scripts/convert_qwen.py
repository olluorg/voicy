"""Qwen3-TTS → GGUF и ONNX: единственный шаг установки, которому нужен Python.

    python scripts/convert_qwen.py        →  ~/.cache/voicy/models/qwen3-tts-12hz-1.7b-base-gguf

Всё остальное — библиотеки движков и модели Whisper, Silero и Smart Turn —
качает сам сервер: `voicy setup`. Здесь только перевод официальных весов
